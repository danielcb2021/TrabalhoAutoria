...
async function cadastrarLivro(event) {
  ...
  const lancamentoValor = document.getElementById("livro_lancamento_formulario").value;
  const generoValor = document.getElementById("livro_genero_formulario").value;
  
  const novoLivro = { titulo: tituloValor, autor: autorValor, data_lancamento: lancamentoValor, genero: generoValor };
  ...
  try {
    ...
    await renderizarListaLivros(componentePrincipal);
  } catch (error) {
 ...
 */
async function renderizarListaLivros(componentePrincipal) {
  try {
...
async function excluirLivro(id) {
  try {
    ...
    const componentePrincipal = document.querySelector("#conteudo_principal");
    renderizarListaLivros(componentePrincipal);
  } catch (error) {
...
async function atualizarLivro(event) {
  ...
  const lancamentoValor = document.getElementById("livro_lancamento_formulario").value;
  const generoValor = document.getElementById("livro_genero_formulario").value;
  const livro = {id: idValor, titulo: tituloValor, autor: autorValor,
    data_lancamento: lancamentoValor, genero: generoValor };
